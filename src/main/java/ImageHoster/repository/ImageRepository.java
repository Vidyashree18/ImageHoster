...
public class ImageRepository {
    ...
    public Image getImageObject(Integer imageId, String title) {
        EntityManager em = emf.createEntityManager();
        try {
            TypedQuery<Image> typedQuery = em.createQuery("SELECT i from Image i where i.title =:title and i.id = :id", Image.class).setParameter("title", title).setParameter("imageId", imageId);
